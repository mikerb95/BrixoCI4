    ...
    <div class="chat-container">
        <div class="chat-header">
            <div class="d-flex align-items-center">
                <a href="<?= base_url('/mensajes') ?>" class="btn btn-link text-dark me-2"><i class="fas fa-arrow-left"></i></a>
                <div>
        ...
        <div class="chat-messages" id="chatMessages">
            <?php foreach ($mensajes as $msg): ?>
                <div class="message <?= ($msg['remitente_id'] == $miId && $msg['remitente_rol'] == $miRol) ? 'sent' : 'received' ?>">
                    <?= esc($msg['contenido']) ?>
        ...
        <div class="chat-input-area">
            <form id="chatForm" class="d-flex gap-2">
                ...
                <input type="text" name="contenido" id="messageInput" class="form-control" placeholder="Escribe un mensaje..." autocomplete="off" required>
