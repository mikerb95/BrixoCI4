...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="col-lg-8">
        ...
        <div class="mb-4">
            <div class="mb-2">
                <img src="<?= $service['imagenes'][0] ?>" id="mainImage" class="gallery-main-img shadow-sm"
        ...
        <div class="d-lg-none mb-4">
            ...
            <h2 class="fw-bold text-primary mb-0">$<?= number_format($service['precio'], 0, ',', '.') ?> <span
                    class="fs-6 text-muted fw-normal">/ <?= $service['unidad'] ?></span></h2>
        </div>
        ...
        <section class="mb-5">
            ...
            <div class="card border-0 bg-light rounded-4 p-4">
                <div class="d-flex align-items-center">
                    <img src="<?= $service['profesional']['imagen'] ?>" class="rounded-circle me-3" width="80"
                        height="80" alt="Pro">
                    <div>
            ...
            <div class="card shadow-sm border rounded-4">
                <div class="card-body p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex align-items-baseline">
                            <h2 class="fw-bold text-dark mb-0">$<?= number_format($service['precio'], 0, ',', '.') ?>
                            </h2>
                    ...
                    <div class="mt-3 text-center">
                        <small class="text-muted"><i class="fas fa-shield-alt text-success me-1"></i> Garantía de
                ...
                <div class="card-footer bg-light p-3 rounded-bottom-4">
                    <div class="d-flex align-items-start gap-2">
                        ...
                        <small class="text-muted lh-sm">El precio final puede variar dependiendo de los detalles
                            específicos de tu proyecto. Solicita una cotización para obtener un precio exacto.</small>
                    </div>
                </div>
            </div>
        </div>
